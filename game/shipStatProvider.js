...
const SHIPS = {
  ...
  human_demeter: {
    ...
    energyMax: 140,
    energyRegen: 12,
    image: "humans/human_demeter1.png",
    shieldDiameterPx: 50,
    shieldRegen:3,
    firerateMult: 0.80,
    CPU:25,
  ...
  human_mercury: {
    ...
    energyMax: 160,
    energyRegen: 14,
    image: "humans/human_mercury1.png",
    shieldDiameterPx: 35,
    shieldRegen:1.5,
    firerateMult: 0.5,
    CPU:8,
  ...
  human_icarus: {
    ...
    energyMax: 190,
    energyRegen: 16,
    image: "humans/human_icarus1.png",
    shieldDiameterPx: 36,
    shieldRegen:1.25,
    firerateMult: 0.90,
    damageMult:1.25,
  ...
  human_hermes: {
    ...
    energyMax: 230,
    energyRegen: 22,
    image: "humans/human_hermes1.png",
    shieldDiameterPx: 44,
    shieldRegen:3,
    damageMult:1.25,
    firerateMult:1.25,
  ...
  human_gunship: {
    ...
    energyMax: 320,
    energyRegen: 38,
    image: "humans/human_gunship1.png",
    shieldDiameterPx: 45,
    shieldRegen:2,
    firerateMult: 1.5,
    damageMult: 1.1,
  ...
  human_artemis: {
    ...
    image: "humans/human_artemis1.png",
    engineFlareType: "triangular",
    engineFlareWidth: 15,
  ...
  human_athena: {
    ...
    speed: 150,
    acceleration: 40,
    turningSpeedRad: (Math.PI * 0.25) * 1.0,
    image: "humans/human_athena1.png",
    engineFlareType: "triangular",
    engineFlareWidth: 15,
    engineFlareLength: 42,
    shieldDiameterPx: 80,
    ...
    shipCenter: { x: 0.5, y: 0.5 }, // normalized (0..1) relative to sprite
    engineCoords: [{ x: 0, y: 20 }],
    weaponGunCoords: [{type: "turret", x: 20, y: 0 },{type: "turret", x: 15, y: 0 }, {type: "turret", x:-15, y: 0 }, {type: "turret", x: 20, y: 0 }],
  },
  ...
  jared_three_eyes_spike_hybrid: {
    ...
    image: "jareds/jared_three_eyes_spike_hybrid1.png",
    shieldDiameterPx: 50,
    firerateMult: 1.4,
    energyMax: 160,
    energyRegen: 14,
  ...
  jared_berseker: {
    ...
    engineFlareWidth: 14,
    engineFlareLength: 47,
    image: "jareds/jared_berseker1.png",
    shieldDiameterPx: 50,
    firerateMult: 1.4,
    energyMax: 160,
    energyRegen: 14,
  ...
  jared_jeweled: {
    ...
    engineFlareWidth: 14,
    engineFlareLength: 47,
    image: "jareds/jared_jeweled1.png",
    shieldDiameterPx: 90,
    firerateMult: 1.4,
    energyMax: 160,
    energyRegen: 14,
  ...
  jared_queen: {
    ...
    speed: 20,
    acceleration: 10,
    turningSpeedRad: (Math.PI * 1.45) * 0.3,
    engineFlareType: "flagellum",
    engineFlareWidth: 14,
    engineFlareLength: 47,
    image: "jareds/jared_queen_gold.png",
    shieldDiameterPx: 100,
    firerateMult: 1.4,
    energyMax: 160,
    energyRegen: 100,
  ...
  technician_spike_razor_upgraded: {
    ...
    image: "technicians/technician_spiker.png",
    shieldDiameterPx: 84,
    CPU:36,
    energyMax: 320,
    energyRegen: 38,
  ...
  technician_spike_razor: {
    ...
    image: "technicians/technician_spike.png",
    shieldDiameterPx: 86,
    CPU:40,
    energyMax: 320,
    energyRegen: 38,
  ...
  technician_motherlode: {
    ...
    energyMax: 300,
    energyRegen: 28,
    image: "technicians/technician_motherlode_defensive.png",
  ...
  technician_hard_shell_v1: {
    ...
    engineFlareWidth: 28,
    engineFlareLength: 42,
    image: "technicians/technician_hard_shell_v1.png",
  ...
  technician_singularity: {
    ...
    speed: 50,
    acceleration: 20,
    turningSpeedRad: (Math.PI * 0.50) * 1.2,
    engineFlareType: "sphere",
    engineFlareWidth: 40,
    engineFlareLength: 80,
    image: "technicians/technician_singularity1.png",
    shieldDiameterPx: 200,
    CPU:1000,
    outfitSpace: 3000,
    shipCenter: { x: 0.52, y: 0.54 },
    engineCoords: [{ x: 0.10, y: 0.50 }],
    weaponGunCoords: [{ x: 0.85, y: 0.45 }, { x: 0.85, y: 0.55 }],
  },
};
